...
<html lang="en">
  <head>
    ...
    <title>Range Forest Officer - Wildlife Protection Act</title>
...
<div class="nav">
  ...
  <div>
    ...
    <a href="rfo-arg.php" class="btn btn-warning"> <-- Back to Previous Page</a>
    </div>

<?php include "wildlife-protection-act.php";?>
