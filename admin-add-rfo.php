...
<div class="nav">
  ...
  <div>
    <ul id="sidebar">
      ...
      <li><a class="active" href="#"id="sidebar-item">Add Range forest Officer</a></li>
        ...
        $conn = mysqli_connect($server, $username_server, $password_server, $database);
          if (!$conn)
          ...
          else 
            {
              ...
              $sql = "INSERT INTO `login` (`name`, `username`, `password`, `role`, `forest_area`, `forest_department`) VALUES ('$name', '$username', '$password', 'rfo', '$forest_area', '$forest_department')";
...
<div class="addlogins">
  <form action="admin-add-rfo.php" method="post">
...
<table class="table table-hover table-bordered table-striped" style="margin-top :30px;">
  ...
  <tbody>
    <?php 
        ...
        $sql = "SELECT * FROM login WHERE role='rfo'";
        $result = mysqli_query($conn, $sql);
