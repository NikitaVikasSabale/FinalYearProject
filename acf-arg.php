...
<html lang="en">
  <head>
    ...
    <title>Assistant Conservator of Forest - Acts , Rules & Guidelines</title>
    ...
    <div class="col-sm-4">
      <div class="card bg-warning" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="acf-i-f-a.php" class="btn btn-outline-dark">Read More ...</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-4">
      <div class="card bg-warning" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="acf-w-p-a.php" class="btn btn-outline-dark">Read More ...</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-4">
      <div class="card bg-warning" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="acf-f-c-a.php" class="btn btn-outline-dark">Read More ...</a>
        </div>
      </div>
    </div>
  </div>
