...
<div class="nav">
  ...
  <div>
    <ul id="sidebar">
      ...
      <li><a class="active" href="#" id="sidebar-item">Add Forester</a></li>
      <li><a href="admin-add-rfo.php" id="sidebar-item">Add Range forest Officer</a></li>
      <li><a href="admin-add-acf.php" id="sidebar-item">Add Assistant Conservator of Forest</a></li>
        ...
        $conn = mysqli_connect($server, $username_server, $password_server, $database);
          if (!$conn)
          ...
          else 
            {
              ...
              $sql = "INSERT INTO `login` (`name`, `username`, `password`, `role`, `forest_area`, `forest_department`, `circle`) VALUES ('$name', '$username', '$password', 'forester', '$forest_area', '$forest_department', '$circle')";
...
<div class="addlogins">
  <form action="admin-add-forester.php" method="post">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-2">
            ...
            <select class="form-control" id="forest_area" name="forest_area">
                <option>-</option>
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control"  id="circle" name="circle" placeholder="circle" required>
        </div>
...
<table class="table table-hover table-bordered table-striped" style="margin-top :30px;">
  ...
  <tbody>
    <?php 
        ...
        $sql = "SELECT * FROM login WHERE role='forester'";
        $result = mysqli_query($conn, $sql);
