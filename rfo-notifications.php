...
<html lang="en">
  <head>
    ...
    <title>Range Forest Officer - Notifications</title>
...
<?php 
    ...
    ?>
                  <div class="alert alert-warning col-md-12" role="alert">
                    ...
                    <a href="rfo-notifications-por.php?id=<?php echo $row['id']; ?>" class="alert-link">Click hear to see the details  </a><span style="margin-left: 700px; font-size: 12px;"> <?php echo $row['time'];?> </span>
                  </div>  
    <?php
                }
            }
